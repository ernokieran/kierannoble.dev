...
{
    internal const string TAG_NAME = "template:introduction";
    
    public TemplateIntroduction(IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor) { }

    //TODOK resize avatar to correct size
    protected override string Header => $"""
                                             <header>
                                                 <img src="/img/avatar.webp" class="avatar" height="135px" width="135px" alt="A photo of Kieran" loading="lazy" decoding="async" />
